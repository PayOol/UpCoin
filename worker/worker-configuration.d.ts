/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc` (hash: f4ad5bc99cdeb3381031cc8aad369ae2)
...
interface __BaseEnv_Env {
	...
	SEBPAY_COUNTRY: "CM";
	SEBPAY_CURRENCY: "XAF";
	SEBPAY_OPERATOR_FIELD: "code";
	SEBPAY_PUBLIC_KEY: string;
	SEBPAY_SECRET_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEBPAY_API_BASE_URL" | "ALLOWED_ORIGINS" | "SEBPAY_COUNTRY" | "SEBPAY_CURRENCY" | "SEBPAY_OPERATOR_FIELD" | "SEBPAY_PUBLIC_KEY" | "SEBPAY_SECRET_KEY">> {}
}
